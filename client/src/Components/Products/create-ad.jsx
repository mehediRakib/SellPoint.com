...
const CreateAd = () => {
    ...
    const {
        productSellForm, productSellFormOnchange, productSell, readDivisionDetails, readDivision, readDistrictDetails,
        readDistrict, DivisionName, ReadDivisionByID, DistrictName,ReadDistrictByID
    } = productStore();
    ...
    const postAd = async () => {
        ...
        } else if (DivisionName.division === null || DivisionName.division === "") {
            toast.error("Division Name is Required")
        } else if (DistrictName.district === null || DistrictName.district === "") {
    ...
    useEffect(() => {
        (async () => {
            ...
            await ReadDistrictByID(districtId)
        })()
                    ...
                    <div className="w-2/3 h-auto drop-shadow-md rounded-md py-5 bg-slate-200">
                        ...
                        <div className="flex-grow flex flex-col justify-center w-full">
                            <div className="flex items-center justify-center w-full">
                                <div className="w-2/3">
                                    <div className="my-3">
                                        <label className="text-gray-500 text-sm">Product Name<span
                                            className="text-red-600">*</span>:</label><br/>
                                        <input type="text" value={productSellForm.productName} onChange={(e) => {
                                            productSellFormOnchange("productName", e.target.value)
                                        }}
                                               className="w-full rounded-md border border-cyan-200 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500"
                                               placeholder="Product Name:"/><br/>
                                    </div>
                                    <div className="my-3">
                                        <label className="text-gray-500 text-sm">Brand:</label><br/>
                                        <input type="text" value={productSellForm.brandName} onChange={(e) => {
                                            productSellFormOnchange("brandName", e.target.value)
                                        }}
                                               className="w-full rounded-md border border-cyan-200 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500"
                                    ...
                                    <div className="my-3">
                                        <label className="text-gray-500 text-sm">Price<span
                                            className="text-red-600">*</span>:</label><br/>
                                        <input type="text" value={productSellForm.price} onChange={(e) => {
                                            productSellFormOnchange("price", e.target.value)
                                        }}
                                               className="w-full rounded-md border border-cyan-200 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500 "
                                               placeholder="Price:"/>
                                    </div>
                                    <div className="my-3">
                                        <label className="text-gray-500 text-sm">Condition<span
                                            className="text-red-600">*</span>:</label><br/>
                                        <div className="flex items-center">
                                            <input type="radio"
                                                   ...
                                                   onChange={(e) => {
                                                       productSellFormOnchange("condition", e.target.value)
                                                   }}
                                            />
                                    ...
                                    <div className="my-3">
                                        ...
                                        <input type="text" value={productSellForm.color} onChange={(e) => {
                                            productSellFormOnchange("color", e.target.value)
                                        }}
                                               className="w-full rounded-md border border-cyan-200 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500"
                                               placeholder="Color:"/>
                                    </div>
                                    <div className="my-3">
                                        <label className="text-gray-500 text-sm">Model<span
                                            className="text-red-600">*</span>:</label><br/>
                                        <input type="text" value={productSellForm.model} onChange={(e) => {
                                            productSellFormOnchange("model", e.target.value)
                                        }}
                                               className="w-full rounded-md border border-cyan-200 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500"
                                               placeholder="Model:"/>
                                    </div>
                                    <div className="my-3">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            />
                                            <label htmlFor="unofficialRadio"
                                                   className="ml-2 text-sm text-gray-700">Unofficial</label>
                                        </div>
                                    </div>
                                    <div className="my-3">
                                        <label className="text-gray-500 text-sm">Division<span
                                            className="text-red-600">*</span>:</label><br/>
                                        <select
                                            className="w-full rounded-md border border-cyan-200 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500"
                                            onChange={(e) => {
                                                productSellFormOnchange("division", e.target.value)
                                            }}>
                                    ...
                                    <div className="my-3">
                                        <label className="text-gray-500 text-sm">District<span
                                            className="text-red-600">*</span>:</label><br/>
                                    ...
                                    <div className="my-3">
                                        <label className="text-gray-500 text-sm">Area<span
                                            className="text-red-600">*</span>:</label><br/>
                                        <input type="text" value={productSellForm.area} onChange={(e) => {
                                            productSellFormOnchange("area", e.target.value)
                                        }}
                                               className="w-full rounded-md border border-cyan-200 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500"
                                               placeholder="Area:"/>
                                    </div>
                                    <div className="my-3">
                                        ...
                                        <textarea value={productSellForm.features} onChange={(e) => {
                                            productSellFormOnchange("features", e.target.value)
                                        }}
                                    ...
                                    <div className="my-3">
                                        ...
                                        <textarea value={productSellForm.shortDes} onChange={(e) => {
                                            productSellFormOnchange("shortDes", e.target.value)
                                        }}
                                                  className="resize rounded-md w-full border border-cyan-200 focus:outline-none focus:ring-1 focus:ring-cyan-300 h-20"
                                                ...
                                                <label className="form-label block text-sm font-medium text-gray-700">
                                                    <div className="flex justify-between items-center text-red-500">
                                                        Image 1:*
                                                        {
                                                            img1 !== null ? (
                                                                <div>
                                                                    <button onClick={removeImg1}
                                                                            className="bg-red-600 hover:bg-red-800 text-white font-semibold  px-1 rounded shadow focus:outline-none focus:shadow-outline">
                                                            ...
                                                            <>
                                                                <div className="space-y-1 text-center">
                                                                    ...
                                                                    <label htmlFor="image_1"
                                                                        ...
                                                                        <p className="text-xs text-gray-500">PNG, JPG,
                                                                            GIF up to 10MB</p>
                                                                    </label>
                                                                </div>
                                                            </>
                                        ...
                                        <div className="w-1/3">
                                            <div className="form-group mb-4">
                                                <div className="flex justify-between items-center">
                                                    <label
                                                        className="form-label block text-sm font-medium text-gray-700">Image
                                                        2:</label>
                                                    {
                                                        img2 !== null ? (
                                                            <div>
                                                                <button onClick={removeImg2}
                                                                        className="bg-red-600 hover:bg-red-800 text-white font-semibold  px-1 rounded shadow focus:outline-none focus:shadow-outline">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                         className="h-4 w-4" fill="none"
                                                                         viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="flex items-center justify-center mt-5">
                            <UserSubmitButton
                                className=" bg-green-600 w-1/2 h-10 rounded-full text-white text-lg focus:outline-none focus:ring-2 focus:ring-red-400 hover:bg-red-600 hover:focus:ring-2 hover:focus:outline-none hover:focus:ring-green-600 "
                                onClick={postAd} text="Post ad"/>
                        </div>
