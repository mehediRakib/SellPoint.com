        ...
        <div className="mt-28 flex flex-col items-center justify-center h-full">
            ...
            <div className="w-2/3 h-auto shadow-lg shadow-cyan-400/30 rounded-md">
                ...
                <div className="flex">
                    ...
                    <div className="w-2/6">
                       <div className="border border-gray-300 mr-1 border-t-2 border-t-gray-400 ml-1">
                        ...
                        {/*<hr className="mt-5 border border-gray-400"/>*/}
                       <div className="border border-gray-300 mr-1 mt-10 ml-1">
                           <div className="p-5 flex space-x-2">
                               ...
                               <div>
                                   ...
                                   <li className="text-gray-600">
                                       Never share card details or OTPs, and always verify items in person before payment. SellPoint does not offer a delivery service. Stay vigilant!
                                   </li>
                               </div>
                           </div>
                       </div>
            ...
            <div className="w-2/3 h-full mt-10 shadow-lg shadow-cyan-500/50 flex flex-wrap rounded-md">
...

                {
                    productByCategoryDetails && productByCategoryDetails.map((item, i) => (
                        <div className="flex w-1/2 p-3 mt-3"> {/* Ensure each item takes exactly half of the parent's width */}
                            <div className="flex w-full bg-white shadow border border-cyan-100 overflow-hidden rounded-lg p-5 hover:drop-shadow-lg h-48"> {/* Optional styling */}
