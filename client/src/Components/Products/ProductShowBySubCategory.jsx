...
const ProductShowBySubCategory = () => {
    ...
    const {readClickCategory,ClickCategoryDetails,readSubCategoryDetails,readLocation,readLocationDetails,readSubCategory,productBySubcategoryDetails,productBySubcategory}=productStore();
    ...
    useEffect(() => {
        (async () => {
            ...
            await productBySubcategory(subCategoryId)
        })()
                    ...
                    <div className="w-full sm:w-5/6 shadow-lg h-full">
                        ...
                        <div className="flex flex-col sm:flex-row h-auto">
                                    ...
                                    <div className="ml-10 mt-5">
                                        ...
                                        <div className="ml-8 text-sky-700">
                                            ...
                                            {readSubCategoryDetails && readSubCategoryDetails.map((item, i) => (
                                                <Link to={`/Products/${item['subcategoryName']}/${categoryID}/?subcategoryId=${item['_id']}`} className="hover:underline" key={i}>
                            ...
                            <div className="flex-grow">
                                ...
                                <div className="ml-4">
                                    {productBySubcategoryDetails && productBySubcategoryDetails.map((item, i) => (
...
export default ProductShowBySubCategory;