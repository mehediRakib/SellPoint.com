                ...
                <div className="flex justify-center items-center">
                    <div className="bg-slate-50 rounded-md shadow mt-5 w-2/3">
                        <div className="items-center text-center mt-5  ">
                            <h3 className="font-semibold text-xl mb-4">All Subcategory</h3>
                            <hr/>
                        </div>
                        <div className="flex justify-center items-center">
                                    ...
                                    readSubCategoryDetails && readSubCategoryDetails.map((item, i) => (
                                        <div key={i} className="flex items-center justify-between py-3">
                                            ...
                                            <div className="flex w-1/4 items-center justify-end space-x-5 ml-16">
                                                <Link to={`/admin/edit-subcategory/${item['_id']}?categoryId=${categoryID}`} className="text-gray-600 hover:text-gray-900 focus:outline-none">
